...
download_install() {
  ...
  wget "https://github.com/Yusupoff/my-files/raw/refs/heads/main/luci-app-zapret_${VERSION}-r1_all.ipk" -O "/tmp/luci-app-zapret_${VERSION}-r1_all.ipk" >/dev/null 2>&1 && printf "\033[32;1m\tluci-app-zapret_${VERSION}-r1_all.ipk загружен\033[0m\n" || {
  ...
  opkg install /tmp/luci-app-zapret_${VERSION}-r1_all.ipk  && rm -f /tmp/luci-app-zapret_${VERSION}-r1_all.ipk
}
